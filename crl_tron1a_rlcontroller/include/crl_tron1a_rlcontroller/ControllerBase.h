...
// NOTE: The original ROS2-control controller base class is omitted to avoid
// bringing ros2_control dependencies. Below we only keep math utilities and
// type aliases used by the Tron1A walk controller.
