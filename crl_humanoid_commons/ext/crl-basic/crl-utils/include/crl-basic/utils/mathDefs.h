...
// type alias
using crl::utils::AngleAxisd;
using crl::utils::dVector;
using crl::utils::Matrix;
using crl::utils::Matrix3x3;
using crl::utils::MTriplet;
using crl::utils::P3D;
using crl::utils::Quaternion;
using crl::utils::RigidTransformation;
using crl::utils::SparseMatrix;
using crl::utils::V3D;
using crl::utils::Vector2d;
using crl::utils::Vector3d;

// function alias
using crl::utils::resize;
