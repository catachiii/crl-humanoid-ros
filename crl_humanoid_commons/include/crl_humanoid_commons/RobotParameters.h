    ...
    const std::map<std::string, RobotModel> robotModels = {
        {
            ...
            {RobotModelType::UNITREE_G1,
             ...
             {-0.1000, -0.1000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.3000, 0.3000, 0.3500, 0.3500, -0.2000, -0.2000,
              0.1600,  -0.1600, 0.0000, 0.0000, 0.0000, 0.0000, 0.8700, 0.8700, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000},
             {2.8798, 2.8798, 2.618,  2.9671, 0.5236, 0.52,  2.7576, 2.7576, 0.52,    2.8798,  2.8798,  2.6704,  2.6704,  0.5236, 0.5236,
              2.2515, 1.5882, 0.2618, 0.2618, 2.618,  2.618, 2.0944, 2.0944, 1.97222, 1.97222, 1.61443, 1.61443, 1.61443, 1.61443},
             {-2.5307, -2.5307, -2.618,  -0.5236, -2.9671, -0.52,  -2.7576, -2.7576, -0.52,    -0.087267, -0.087267, -3.0892,  -3.0892,  -0.87267, -0.87267,
              -1.5882, -2.2515, -0.2618, -0.2618, -2.618,  -2.618, -1.0472, -1.0472, -1.97222, -1.97222,  -1.61443,  -1.61443, -1.61443, -1.61443},
             {15.0, 15.0, 10.0, 15.0, 15.0, 8.0,  15.0, 15.0, 8.0,  15.0, 15.0, 20.0, 20.0, 10.0, 10.0,
              20.0, 20.0, 10.0, 10.0, 20.0, 20.0, 25.0, 25.0, 30.0, 30.0, 25.0, 25.0, 25.0, 25.0},
             {88.0, 88.0, 88.0, 139.0, 139.0, 50.0, 88.0, 88.0, 50.0, 139.0, 139.0, 25.0, 25.0, 50.0, 50.0,
              25.0, 25.0, 50.0, 50.0,  25.0,  25.0, 25.0, 25.0, 25.0, 25.0,  5.0,   5.0,  5.0,  5.0},
             {100., 100., 400., 100., 100., 400., 100., 100., 400., 200., 200., 40., 40., 20., 20.,
              60.,  60.,  20.,  20.,  20.,  20.,  60.,  60.,  20.,  20.,  20.,  20., 20., 20.},
             {
                 2.5, 2.5, 5., 2.5, 2.5, 5., 2.5, 2.5, 5., 5., 5., 2.5, 2.5, 0.2, 0.2, 1., 1., 0.1, 0.1, 0.4, 0.4, 1., 1., 0.4, 0.4, 0.4, 0.4, 0.4, 0.4,
             }},
        },
        {
            // Limx WF_TRON1A
            "WF_TRON1A",
            {RobotModelType::LIMX_WF_TRON1A,
             ...
             {// jointPosMax (upper limits from URDF)
              1.39626, 1.396263, 1.361357, 1000000.0, 0.38397, 1.012291, 0.872665, 1000000.0},
             {// jointPosMin (lower limits from URDF)
              -0.38397, -1.012291, -0.872665, -1000000.0, -1.39626, -1.396263, -1.361357, -1000000.0},
             {// jointVelMax (velocity from URDF)
              15.0, 15.0, 15.0, 40.0, 15.0, 15.0, 15.0, 40.0},
             {// jointTorqueMax (effort from URDF)
              80.0, 80.0, 80.0, 40.0, 80.0, 80.0, 80.0, 40.0},
             {// jointStiffnessDefault (from control.yaml / Python)
              42.0, 42.0, 42.0, 0.0, 42.0, 42.0, 42.0, 0.0},
             {// jointDampingDefault (from control.yaml / Python)
              2.5, 2.5, 2.5, 0.8, 2.5, 2.5, 2.5, 0.8}},
        },
    };
